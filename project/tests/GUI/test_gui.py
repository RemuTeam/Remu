...
def test_slave(simulator):
    ...
    simulator.assert_attr("//PresentationLayout//Image[1]", "source", None)
    simulator.tap("//PresentationLayout//Button[1]")
    simulator.assert_attr("//PresentationLayout//Image[1]", "source", "images/b.jpg")
    simulator.tap("//PresentationLayout//Button[1]")
    simulator.assert_attr("//PresentationLayout//Image[1]", "source", "images/a.jpg")
    simulator.tap("//PresentationLayout//Button[1]")
    simulator.assert_text(slave_layout_label(1), "Olet slave-näkymässä")
    simulator.app.close_connections()
